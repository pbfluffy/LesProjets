...
const en = {
  ...
  'sync.error': '⚠️ Sync error',
  'sync.pullNow': '⬇️ Pull from cloud',
  'sync.pushNow': '⬆️ Push to cloud',
...
const th = {
  ...
  'sync.title': '☁️ ซิงค์คลาวด์',
  'sync.signIn': 'เข้าสู่ระบบด้วย Google',
  'sync.signOut': 'ออกจากระบบ',
  'sync.synced': '✅ ซิงค์แล้ว',
  'sync.syncing': '⏳ กำลังซิงค์…',
  'sync.error': '⚠️ ซิงค์ผิดพลาด',
  'sync.pullNow': '⬇️ ดึงจากคลาวด์',
  'sync.pushNow': '⬆️ ส่งขึ้นคลาวด์',
