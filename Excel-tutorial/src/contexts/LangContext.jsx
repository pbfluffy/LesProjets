...
export const UI = {
  en: {
    ...
    stageQuiz: 'Quiz',
    quizComingSoon: 'Quiz — under development',
    nextStage: 'Continue →',
    ...
    completed: 'Completed',
    phase1Note: 'Welcome! Try any formula. Quizzes and game features are still under development.',
  ...
  th: {
    ...
    stagePractice: 'ทดลอง',
    stageQuiz: 'ทดสอบ',
    quizComingSoon: 'แบบทดสอบ — อยู่ระหว่างพัฒนา',
    nextStage: 'ต่อไป →',
    ...
    phase1Note: 'ยินดีต้อนรับ! ลองสูตรไหนก็ได้ แบบทดสอบและฟีเจอร์เกมยังอยู่ระหว่างพัฒนา',
