...
export const promos = [
  ...
  },
  {
    ...
    notes: 'Re-verified Jul 31, 2026 against emart24’s own event page (exact name: 동원)어단백프로틴바두부70g). 117 kcal per 70g found, but no confirmed protein-gram figure.',
  },
  {
    ...
    endDate: '2026-08-31',
    sourceUrl: 'https://emart24.co.kr/goods/event?search=%ED%94%84%EB%A1%9C%ED%8B%B4',
    notes: 'Re-verified Jul 31, 2026 against emart24’s own event page (exact name: 동원)어단백프로틴바닭가슴살70g) — same line as the tofu flavor above, no confirmed protein-gram figure.',
  },
  {
    id: 'cu-orion-probar',
    store: 'CU',
