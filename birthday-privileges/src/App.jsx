...
const STRINGS = {
  th: {
    ...
    all: 'ทั้งหมด',
    category: { cafe: 'คาเฟ่', restaurant: 'ร้านอาหาร', buffet: 'บุฟเฟ่ต์', fastfood: 'ฟาสต์ฟู้ด', entertainment: 'บันเทิง', wellness: 'สปา/เวลเนส' },
  ...
  en: {
    ...
    all: 'All',
    category: { cafe: 'Cafe', restaurant: 'Restaurant', buffet: 'Buffet', fastfood: 'Fast Food', entertainment: 'Entertainment', wellness: 'Spa/Wellness' },
