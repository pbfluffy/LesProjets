...
// Language: 'th' | 'en'. App-local key — defaults to 'th' to match the
// portfolio's default (this content is Thailand-specific).
export function useLang() {
  const [lang, setLang] = useLocalStorage('birthday_privileges_lang', 'th')
