...
export const STRINGS = {
  en: {
    ...
    summaryDividends: 'Dividends',
    summaryTotalReturn: 'Total return',
    ...
    planSectionTitle: 'Investment plan',
    addPlanBtn: '+ Plan',
    planTotalAmountLabel: 'Total amount',
    planCadenceLabel: 'Cadence',
    cadenceMonthly: 'Monthly',
    cadenceQuarterly: 'Quarterly',
    planPeriodsLabel: 'Periods',
    planStartDateLabel: 'Start date',
    savePlanBtn: 'Create plan',
    planCompletedCount: '{done}/{total} done',
    planMarkDoneBtn: 'Mark next done',
    planAllDone: 'All done',
    removePlanLabel: 'Remove plan',
    noPlans: 'No investment plan yet.',
    dividendSectionTitle: 'Dividends',
    addDividendBtn: '+ Dividend',
    dividendAmountLabel: 'Amount',
    dividendDateLabel: 'Date',
    saveDividendBtn: 'Add',
    removeDividendLabel: 'Remove entry',
    noDividends: 'No dividends logged yet.',
    dividendTotal: 'Total received',
    low: 'Low',
    high: 'High',
    band: 'Band',
    signalBuy: 'Buy zone',
  ...
  th: {
    ...
    summaryDividends: 'เงินปันผล',
    summaryTotalReturn: 'ผลตอบแทนรวม',
    ...
    planSectionTitle: 'แผนลงทุนสม่ำเสมอ',
    addPlanBtn: '+ แผน',
    planTotalAmountLabel: 'จำนวนเงินรวม',
    planCadenceLabel: 'ความถี่',
    cadenceMonthly: 'รายเดือน',
    cadenceQuarterly: 'รายไตรมาส',
    planPeriodsLabel: 'จำนวนงวด',
    planStartDateLabel: 'วันที่เริ่ม',
    savePlanBtn: 'สร้างแผน',
    planCompletedCount: 'ทำแล้ว {done}/{total}',
    planMarkDoneBtn: 'ทำเครื่องหมายงวดถัดไป',
    planAllDone: 'ครบทุกงวดแล้ว',
    removePlanLabel: 'ลบแผน',
    noPlans: 'ยังไม่มีแผนลงทุน',
    dividendSectionTitle: 'เงินปันผล',
    addDividendBtn: '+ เงินปันผล',
    dividendAmountLabel: 'จำนวนเงิน',
    dividendDateLabel: 'วันที่',
    saveDividendBtn: 'เพิ่ม',
    removeDividendLabel: 'ลบรายการ',
    noDividends: 'ยังไม่มีการบันทึกเงินปันผล',
    dividendTotal: 'รับรวมทั้งหมด',
    low: 'ต่ำสุด',
    high: 'สูงสุด',
    band: 'ระดับ',
    signalBuy: 'โซนซื้อ',
